...
net = GAIN_DenseNet121.GAIN_DenseNet121(_input_size=input_size, _batch_size=batch_size, _num_classes=num_classes, _num_epoch=num_epoch, isTraining=True, logdir=logdir)
