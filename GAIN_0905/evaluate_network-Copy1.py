...
import kaggle_Face_expression.GAIN_0905.GAIN_DenseNet121_non_cal as GAIN
...
net = GAIN.GAIN_DenseNet121(_input_size=input_size, _batch_size=batch_size, _num_classes=num_classes, _num_epoch=num_epoch, isTraining=False, logdir=logdir)
